...
Bjax.prototype.start=function(){var that=this;this.backdrop();$.ajax(this.options.url).done(function(r){that.$content=r;that.complete();$(window).trigger("resize");});}
...
this.updateBar(100);$(window).trigger("resize");$(document).trigger('updateNav');}
